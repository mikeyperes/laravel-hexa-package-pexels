...
class PexelsServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        if (!config('hexa.app_controls_sidebar', false)) {
            ...
            $registry->registerSidebarLink('pexels.index', 'Pexels', 'M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z', 'Search', 'pexels', 83);
            $registry->registerPackage('pexels', 'hexawebsystems/laravel-hexa-package-pexels', [
                'title' => 'Pexels',
                'description' => 'Stock image search and import tooling powered by the Pexels API.',
                'icon' => 'M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z',
                'color' => 'amber',
                'settingsRoute' => 'pexels.index',
            ]);
        }
    }
}
